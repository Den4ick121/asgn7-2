...
var uname = document.getElementById("feedback");
    ...
    if(!regex.test(username)){
               ...
               uname.innerHTML= " It should be greater than 8 charaters";
                } else {
                uname.innerHTML = '';
                }
        }       
...
var psw = document.getElementById("psw");
    ...
    if(!regex.test(password)){
               ...
               psw.innerHTML= " It should be greater than 8 charaters";
                } else {
                psw.innerHTML = '';
                }
        }       
...
function PasswordC() {
    ...
    if (password != passwordC) {
        ...
        pconfirm.innerHTML = "Password and Confirm Password aren't the same";
    } else {
